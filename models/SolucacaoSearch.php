...
/**
 * SolucacaoSearch represents the model behind the search form about `app\models\Solucao`.
 */
class SolucacaoSearch extends Solucao
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            [['id'], 'integer'],
            [['diagnostico', 'solucao', 'palavras_chaves', 'acao_implementada', 'solucao_implementada', 'efetividade_acao_implementada', 'custos', 'impacto_pedagogico', 'atores_envolvidos'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'diagnostico', $this->diagnostico])
            ->andFilterWhere(['like', 'solucao', $this->solucao])
