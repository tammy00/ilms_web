...
--
-- Host: 127.0.0.1
-- Generation Time: 07-Abr-2017 às 18:57
...
(1, 'Acadêmica', 'Testador', 'teste', 'teste', 'teste', NULL, 2),
(2, 'Acadêmica', 'Testador', 'teste', 'teste', 'teste', NULL, 2);
...
(1, '2017-04-06', 'Tipo Caso', 40, 'Polo Teste', 2, 1);
...
(1, 1, 1, 2, 'Testador', 'Acadêmica', 'teste', 'teste', 'teste', 1, NULL),
(2, 1, 1, 2, 'Testador', 'Acadêmica', 'teste', 'teste', 'teste', 1, NULL),
(3, 1, 1, 2, 'Testador', 'Acadêmica', 'teste', 'teste', 'teste', 1, NULL),
(4, 1, 1, 2, 'Testador', 'Acadêmica', 'teste', 'teste', 'teste', 0, NULL),
(5, 1, 1, 2, 'Testador', 'Acadêmica', 'teste', 'teste', 'teste', 0, NULL),
(6, 1, 1, 2, 'Testador', 'Acadêmica', 'teste', 'teste', 'teste', 0, NULL),
(7, 1, 1, 2, 'Testador', 'Acadêmica', 'teste', 'teste', 'teste', 1, NULL),
(8, 1, 1, 2, 'Testador', 'Acadêmica', 'teste', 'teste', 'teste', 1, NULL),
(9, 1, 1, 2, 'Testador', 'Acadêmica', 'teste', 'teste', 'teste', 1, NULL),
(10, 1, 1, 2, 'Testador', 'Acadêmica', 'teste', 'teste', 'teste', 1, NULL),
(11, 1, 1, 2, 'Testador', 'Acadêmica', 'teste', 'teste', 'teste', 0, NULL),
(12, 1, 1, 2, 'Testador', 'Acadêmica', 'teste', 'teste', 'teste', 2, NULL);
...
(2, 'Polo Teste', 'Testador', 'Não sei', 'Não sei', 'Não sei', 'Não sei', 'Não sei', NULL, NULL, NULL, NULL);
...
(1, 'teste', 'teste', 'teste', 'teste', 'teste', 'teste', 'teste', 'teste', NULL),
(2, 'teste', 'teste', 'teste', 'teste', 'teste', 'teste', 'teste', 'teste', NULL);
...
--
ALTER TABLE `descricao`
  MODIFY `id_descricao` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `info_caso`
  MODIFY `id_infoc` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `polo`
  MODIFY `id_polo` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `relator`
  MODIFY `id_relator` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `solucao`
--
ALTER TABLE `solucao`
  MODIFY `id_solucao` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
