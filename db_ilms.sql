...
--
-- Host: 127.0.0.1
-- Generation Time: 19-Out-2018 às 06:16
...
(26, 'Infraestrutura/Administrativo', 'Coordenador Curso', 'Solicitação de adiamento de atividades devido a problemas de energia.', 'Alunos solicitaram adiamento de atividade alegando problemas de energia elétrica, durante dois dias seguidos, na sede do polo. ', 'Adiamento, energia.', NULL, 10),
...
(31, 'Infraestrutura/Administrativa', 'Professor', 'A ausência de conexão com a internet durante 7 dias prejudicaria diretamente os alunos da disciplina, pois comprometeria o andamento e as avaliações da Unidade I da disciplina.\r\nAs atividades de avaliação desta unidade tinham como prazo final dia 20/10/2014.', 'A ausência de conexão com a internet durante 7 dias prejudicaria diretamente os alunos da disciplina, pois comprometeria o andamento e as avaliações da Unidade I da disciplina.\r\nAs atividades de avaliação desta unidade tinham como prazo final dia 20/10/2014.', 'internet', NULL, 7),
(32, 'Infraestrutura/Administrativa', 'Professor', 'A ausência de conexão com a internet durante 7 dias prejudicaria diretamente os alunos da disciplina, pois comprometeria o andamento e as avaliações da Unidade I da disciplina.\r\nAs atividades de avaliação desta unidade tinham como prazo final dia 20/10/2014.', 'A ausência de conexão com a internet durante 7 dias prejudicaria diretamente os alunos da disciplina, pois comprometeria o andamento e as avaliações da Unidade I da disciplina.\r\nAs atividades de avaliação desta unidade tinham como prazo final dia 20/10/2014.', 'internet', NULL, 7);
...
(28, 'Fig28_FundAnatomia_Boa_G', 'LPGraph', 'Trilha de Aprendizagem', 'Educação Física', 'Fundamentos da Anatomia', 'Boa Vista', '2013/1', 26, 'trilha de aprendizagem', 'Dados do gráfico:\\r\\n- Cada Tópico corresponde a uma Unidade na sala virtual.\\r\\n- Os Vértices armazenam as seguintes informações:\\r\\n•	Sequência definida pelo docente para recursos e atividades;\\r\\n•	Nome do recurso/atividade;\\r\\n•	Tipo do recurso/atividade;\\r\\n•	Tópico (unidade) do vértice;\\r\\n•	Número de interações (V): tamanho do vértice.\\r\\nAnálise do gráfico:\\r\\n- Navegação mais concentrada, o que pode ser observado pelas arestas mais largas.\\r\\n-  Verificar que os alunos retornaram mais aos recursos anteriores, quando isso ocorre, indica que a turma teve dificuldades para compreender o assunto do tópico.\\r\\n- Uma proporção maior do número de arestas vermelhas indica que há uma grande chance de a turma estar enfrentando dificuldades no aprendizado.\\r\\nResultados a considerar:\\r\\n- Verificar se a turma costuma acessar os recursos diretamente.\\r\\n- Acessaram pouco alguns determinados recursos, como por exemplo, os links externos (URL)\\r\\n- Alunos com notas altas: poucas arestas, em sua maioria de avanço.\\r\\n- Alunos com notas baixas: há mais arestas e elas estão mais dispersas, em geral a quantidade de arestas de retorno (vermelhas) é maior que os demais tipos.'),
(29, 'Fig29_InformaticaBasica_Tef_G', 'LPGraph', 'Trilha de Aprendizagem', 'Ciências Agrárias', 'Informática Básica', 'Tefé', '2016/1', 15, 'trilha de aprendizagem', 'Dados do gráfico:\\r\\n- Cada Tópico corresponde a uma Unidade na sala virtual.\\r\\n- Os Vértices armazenam as seguintes informações:\\r\\n•	Sequência definida pelo docente para recursos e atividades;\\r\\n•	Nome do recurso/atividade;\\r\\n•	Tipo do recurso/atividade;\\r\\n•	Tópico (unidade) do vértice;\\r\\n•	Número de interações (V): tamanho do vértice.\\r\\nAnálise do gráfico:\\r\\n- Navegação mais concentrada, o que pode ser observado pelas arestas mais largas.\\r\\n-  Verificar que os alunos retornaram mais aos recursos anteriores, quando isso ocorre, indica que a turma teve dificuldades para compreender o assunto do tópico.\\r\\n- Uma proporção maior do número de arestas vermelhas indica que há uma grande chance de a turma estar enfrentando dificuldades no aprendizado.\\r\\nResultados a considerar:\\r\\n- Verificar se a turma costuma acessar os recursos diretamente.\\r\\n- Acessaram pouco alguns determinados recursos, como por exemplo, os links externos (URL)\\r\\n- Alunos com notas altas: poucas arestas, em sua maioria de avanço.\\r\\n- Alunos com notas baixas: há mais arestas e elas estão mais dispersas, em geral a quantidade de arestas de retorno (vermelhas) é maior que os demais tipos.'),
(30, 'Fig30_RitmoMovimento_Sta_G', 'LPGraph', 'Trilha de Aprendizagem', 'Educação Física', 'Ritmo e Movimento', 'Santa Isabel do Rio Negro', '2015/1', 22, 'trilha de aprendizagem', 'Dados do gráfico:\\r\\n- Cada Tópico corresponde a uma Unidade na sala virtual.\\r\\n- Os Vértices armazenam as seguintes informações:\\r\\n•	Sequência definida pelo docente para recursos e atividades;\\r\\n•	Nome do recurso/atividade;\\r\\n•	Tipo do recurso/atividade;\\r\\n•	Tópico (unidade) do vértice;\\r\\n•	Número de interações (V): tamanho do vértice.\\r\\nAnálise do gráfico:\\r\\n- Navegação mais concentrada, o que pode ser observado pelas arestas mais largas.\\r\\n-  Verificar que os alunos retornaram mais aos recursos anteriores, quando isso ocorre, indica que a turma teve dificuldades para compreender o assunto do tópico.\\r\\n- Uma proporção maior do número de arestas vermelhas indica que há uma grande chance de a turma estar enfrentando dificuldades no aprendizado.\\r\\nResultados a considerar:\\r\\n- Verificar se a turma costuma acessar os recursos diretamente.\\r\\n- Acessaram pouco alguns determinados recursos, como por exemplo, os links externos (URL)\\r\\n- Alunos com notas altas: poucas arestas, em sua maioria de avanço.\\r\\n- Alunos com notas baixas: há mais arestas e elas estão mais dispersas, em geral a quantidade de arestas de retorno (vermelhas) é maior que os demais tipos.');
...
(1, '2018-10-16', 'Tipo Caso', 40, 'Tefé', 31, 8),
(2, '2018-10-16', 'Tipo Caso', 40, 'Tefé', 32, 8);
...
(31, 1, 3, '', '', '2015-10-10', '2018-10-18', 'Ketlen Teles', NULL, 0),
(32, 1, 3, '', '', '2015-10-10', '2018-10-18', 'Ketlen Teles', NULL, 0);
...
(31, 'Conteúdo deveria ser repassado diretamente aos alunos através de cópia de arquivos e as atividades avaliativas deveriam ser coletadas pelo tutor presencial de forma off-line.', 'Conteúdo off-line, atividades off-line', '- Contato do coordenador de polo com o coordenador de curso, para relato do problema e tomada de decisões.\r\n- Repasse dos arquivos com o conteúdo da Unidade I para os alunos.\r\n- Coleta das atividades avaliativas de forma off-line (arquivos e mensagens de fórum).', 'Sim', 'Sim', 'Não houve', 'Não houve', 'Coordenador do curso, coordenador de polo, tutor presencial', NULL),
(32, 'Conteúdo deveria ser repassado diretamente aos alunos através de cópia de arquivos e as atividades avaliativas deveriam ser coletadas pelo tutor presencial de forma off-line.', 'Conteúdo off-line, atividades off-line', '- Contato do coordenador de polo com o coordenador de curso, para relato do problema e tomada de decisões.\r\n- Repasse dos arquivos com o conteúdo da Unidade I para os alunos.\r\n- Coleta das atividades avaliativas de forma off-line (arquivos e mensagens de fórum).', 'Sim', 'Sim', 'Não houve', 'Não houve', 'Coordenador do curso, coordenador de polo, tutor presencial', NULL);
...
--
ALTER TABLE `descricao`
  MODIFY `id_descricao` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
...
--
ALTER TABLE `pesquisas`
  MODIFY `id_pesquisa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
...
--
ALTER TABLE `solucao`
  MODIFY `id_solucao` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
